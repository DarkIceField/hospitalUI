			...
			<view class="basic-msgbox">
				<view class="line">
					<view class="item">
						...
						<view class="show">{{userName}}</view>
					</view>
					<view class="item">
						<view class="title">性别：</view>
						<view class="show">{{userSex}}</view>
					</view>
					<view class="item">
						<view class="title">年龄：</view>
						<view class="show">{{userAge}}</view>
					</view>
				</view>
				<view class="line">
					<view class="item">
						<view class="title">住址：</view>
						<view class="show">{{patientAddress}}</view>
					</view>
				</view>
				<view class="line">
					<view class="item">
						<view class="title">联系方式：</view>
						<view class="show">{{userContact}}</view>
					</view>
				</view>
			</view>
